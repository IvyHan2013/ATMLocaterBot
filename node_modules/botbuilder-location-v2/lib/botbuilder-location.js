...
exports.createLibrary = function (bingApiKey, googleApiKey) {
    if (typeof bingApiKey === "undefined" || typeof googleApiKey === "undefined") {
        throw "'apiKey' parameter missing";
    }
    var lib = new botbuilder_1.Library(consts_1.LibraryName);
    retrieveFavoriteLocationDialog.register(lib, googleApiKey);
    retrieveLocationDialog.register(lib, bingApiKey, googleApiKey);
